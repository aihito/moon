...
static int lcreate(lua_State* L)
{
  ...
  {
    luaL_Reg l[] = {{"load_dynamic", load_dynamic}, {"find_straight_path", find_straight_path}, {"valid", valid}, {"random_position", random_position}, {"random_position_around_circle", random_position_around_circle}, {"recast", recast}, {"add_capsule_obstacle", add_capsule_obstacle}, {"remove_obstacle", remove_obstacle}, {"clear_all_obstacle", clear_all_obstacle}, {"update", update}, {NULL, NULL}};
    luaL_newlib(L, l);              //{}
